...
const Footer = () => {
    return (
        <div>
            <footer className="hide-on-print px-4 divide-y bg-gray-800 text-gray-100">
                <div className="container flex flex-col justify-between py-10 space-y-8 lg:flex-row lg:space-y-0 gap-10 max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 text-sm gap-x-3 gap-y-8 w-full lg:w-5/6 md:grid-cols-4 lg:grid-cols-4 ">
                        <div className="space-y-3 col-span-2" >
                            ...
                            <ul className="space-y-1">
                                ...
                                <li>
                                    <p>web@programming-hero.com</p>
                                </li>
                                <li>
                                    <p>Helpline: 01322901105</p>
                                </li>

                            </ul>
                        </div>
                        <div className="space-y-3">
                            <h3 className="tracki uppercase text-gray-50 font-medium">Company</h3>
                            <ul className="space-y-1">
                                <li>
                                    <p>Privacy</p>
                                </li>
                        ...
                        <div className="flex flex-col gap-2 ">
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-start space-x-3">
                                    ...
                                    <a href="//api.whatsapp.com/send?phone=8801732433339" 	target="_blank" rel="noopener noreferrer">  <FaWhatsapp className="text-2xl" /></a>
